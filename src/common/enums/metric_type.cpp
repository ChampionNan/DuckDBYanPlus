...
profiler_settings_t MetricsUtils::GetOptimizerMetrics() {
    return {
        ...
        MetricsType::OPTIMIZER_AGGREGATION_PUSHDOWN,
    };
}
...
MetricsType MetricsUtils::GetOptimizerMetricByType(OptimizerType type) {
    switch(type) {
        ...
        case OptimizerType::AGGREGATION_PUSHDOWN:
            return MetricsType::OPTIMIZER_AGGREGATION_PUSHDOWN;
       default:
...
OptimizerType MetricsUtils::GetOptimizerTypeByMetric(MetricsType type) {
    switch(type) {
        ...
        case MetricsType::OPTIMIZER_AGGREGATION_PUSHDOWN:
            return OptimizerType::AGGREGATION_PUSHDOWN;
    default:
