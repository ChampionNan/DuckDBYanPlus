...
const StringUtil::EnumStringLiteral *GetMetricsTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(MetricsType::OPTIMIZER_AGGREGATION_PUSHDOWN), "OPTIMIZER_AGGREGATION_PUSHDOWN" }
	};
	return values;
}
...
const StringUtil::EnumStringLiteral *GetOptimizerTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(OptimizerType::AGGREGATION_PUSHDOWN), "AGGREGATION_PUSHDOWN" }
	};
	return values;
}
